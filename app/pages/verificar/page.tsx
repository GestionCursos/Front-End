                    ...
                    {loading ? (
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-green-50 border border-green-200 text-green-800 p-4 rounded-md text-center shadow-sm">
                                ...
                                <p className="text-sm">
                                    Este certificado pertenece a <span className="font-medium text-foreground">{dataEstudiante.nombre}</span> y ha sido verificado exitosamente en nuestro sistema.
                                    Los datos del titular coinciden con los registros oficiales.
                                </p>
                                <p className="text-sm mt-2">
                                    <strong>Evento:</strong> <span className="text-foreground">{dataEstudiante.evento}</span>
                                </p>
                            </div>
                        </div>
                    ) : (
